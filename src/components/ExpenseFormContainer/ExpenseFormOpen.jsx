    ...
    <Container maxWidth="md" >
      ...
      <form noValidate onSubmit={submitHandler}>
        <Grid container spacing={3}>
          <Grid item xs={6}>
            <TextField label="Name of Expense" fullWidth name="title" onChange={changeHandler} error={titleError}/>
          </Grid>
          <Grid item xs={6}>
            <TextField label="Amount" type="number" name="amount" onChange={changeHandler}
              step="0.01" fullWidth inputProps={{ min: 0, max: 999999.99, step: 0.01 }}
             />
          </Grid>
          <Grid item xs={6}>
